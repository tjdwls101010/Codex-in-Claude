...
| Requirement | Notes |
|---|---|
| [Codex CLI](https://developers.openai.com/codex/cli) | Verified against `0.147.0`. Must already be authenticated — run `codex login` and confirm `codex login status` exits `0` before going further. |
